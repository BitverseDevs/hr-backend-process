# Generated by Django 4.2 on 2023-05-09 03:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('date_deleted', models.DateTimeField(blank=True, null=True)),
                ('branch_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.branch')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('civil_status', models.PositiveSmallIntegerField(choices=[(1, 'Single'), (2, 'Married'), (3, 'Annulled'), (4, 'Widowed'), (5, 'Separated')], default=1, validators=[django.core.validators.MaxValueValidator(5)])),
                ('gender', models.CharField(choices=[('m', 'Male'), ('f', 'Femals')], max_length=1)),
                ('address', models.TextField(max_length=50)),
